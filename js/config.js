(function () {
    ...
    // The https://roadmap-manager-latest.onrender.com string is replaced during the GitHub Actions build process
    const productionUrl = 'https://roadmap-manager-latest.onrender.com';
